...
public class WorkWithMongo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("В коллекции service-prop-02-checkPointDetailsType содержится -  " + client.getDatabase("cp_registry")
            .getCollection("service-prop-02-checkPointDetailsType").countDocuments() + " записей");
